class Main extends egret.DisplayObjectContainer {
    ...
    private createGameScene() {
        ...
        // 背景
        let pageOneBg = this.createBitmapByName("p_one_bg_png");
        ...
        // 地球
        let earth = this.createBitmapByName("p_one_footer_png");
        this.addChild(earth);
        earth.width = stageW;
        earth.x = 0;
        earth.y = 590;
        // 边角
        let angular = this.createBitmapByName("p_one_angular_png");
        ...
        // 标题文字
        let title = this.createBitmapByName("p_one_title_png");
        this.addChild(title);
        ...
        title.y = 40;
        // 内容边框
        let wordContainer = this.createBitmapByName("p_one_wordContainer_png");
        ...
        // music
        let musicon = this.createBitmapByName("music_on_png");
    ...
    private wordOne: egret.TextField;
    private wordTwo: egret.TextField;
    private wordThree: egret.TextField;
    ...
    */    
    private typerEffect(obj,content:string = "",interval:number = 200,backFun:Function = null):void{
        ...
        var sound:egret.Sound = RES.getRes("7571_wav");
        let self = this
        for (var i = 0; i < len; i++){
            egret.setTimeout(function () {              
    ...
    * 第二页
    */
    private pageTwoScene() {
        // 边角
        let pageTwoAngular = this.createBitmapByName("p_two_angular_png");
        ...
        // 表盘
        let circle = this.createBitmapByName("p_two_midcircle_png");
        ...
        // 表针
        let arrow = this.createBitmapByName("p_two_arrow_png");
        this.addChild(arrow);
        arrow.width = 600;
        arrow.height = 600;
        arrow.x = 20;
        ...
        // 表刻度
        // 12点机器人
        let robot = this.createBitmapByName("p_two_robot_1_png");
        this.addChild(robot);
        robot.width = 150;
        robot.height = 150;
        robot.x = 245;
        ...
        robot.y += 75;
        // 3点
        let personOne = this.createBitmapByName("p_two_person_1_png");
        ...
        let robotOne = this.createBitmapByName("p_two_robot_2_png");
        ...
        // 6点
        let personTwo = this.createBitmapByName("p_two_person_2_png");
        ...
        let robotTwo = this.createBitmapByName("p_two_robot_3_png");
        ...
        // 9点
        let personThree = this.createBitmapByName("p_two_person_3_png");
        ...
        let robotThree = this.createBitmapByName("p_two_robot_4_png");
        ...
        let timer = new egret.Timer(1000/30, 0);
        let timeAni:boolean = true;
        ...
        // 问题
        let pageTwoWord = this.createBitmapByName("p_two_word_png");
        ...
        //按钮
        let pageTwoBUtton = this.createBitmapByName("p_two_button_png");
